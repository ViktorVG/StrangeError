...
{
    public class CrimsonsCry : ModItem //make sure the sprite file is named like the class name (CustomYoyo)
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Crimson's cry");//the name displayed when hovering over the Weapon ingame.
            Tooltip.SetDefault("the poison in this yo-yo causes the skin to decompose faster, and it can also destroy some materials faster. Fortunately for many, the effect is temporary");
        }
        ...
        public override void SetDefaults()
        {
            ...
            item.useAnimation = 35;   //How long the Weapon is used for.
            ...
            item.value = Item.buyPrice(gold: 5, silver: 10, copper: 10); // How much the item is worth, in copper coins, when you sell it to a merchant. It costs 1/5th of this to buy it back from them. An easy way to remember the value is platinum, gold, silver, copper or PPGGSSCC (so this item price is 10gold)
            ...
            item.shoot = mod.ProjectileType("CrimsonsCryProjectile"); //This defines what type of projectile this weapon will shot            
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(ItemID.TissueSample, 5); //this is how to add an ingredient from your mod,  so to craft this item you need 10 Dirt Block and 10 CustomOre
