...
{
    public class CrimsonsCryProjectile : ModProjectile //make sure the sprite file is named like the class name (CustomYoyoProjectile)
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Crimson's cry"); //this is the projectile name,
        }
        ...
        {
            target.AddBuff(mod.BuffType("BloodAnce"), 600);    //this adds the buff to the npc that got hit by this projectile , 600 is the time the buff lasts
        }
        ...
        public override void AI()
        {
            ...
            {// DustID.Fire is a vanilla terrraria dust, change it to what you like. To add a modded dust the change DustID.Fire with mod.DustType("DustName")
                Dust.NewDust(projectile.position + projectile.velocity, projectile.width, projectile.height, mod.DustType("CryDust"), projectile.velocity.X * 1f, projectile.velocity.Y * 1f);
            }
        }
